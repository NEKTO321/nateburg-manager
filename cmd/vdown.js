...
module.exports = {
    name: 'армия-понизить', // name of the command
    ...
    run: async(client, message, args) => {
        ...
        if(azvan === 0) {
            ...
            .setDescription(`${user} понижен (Армия)`)// if there is reason provided then show the reason, if not then show 'No reson provided'
            .setColor('#FF0000')
            client.channels.cache.get('1040670230818599043').send({embeds: [embed]})
            let dm = new MessageEmbed()
            .setDescription(`Поздравляю!\nВы понижены, ваша новая роль: Рекрут (Армия)`)
            .setColor('#2ecc71')
            user.send({ embeds: [dm] })
        ...
        if(azvan === 1) {
            ...
            client.channels.cache.get('1040670230818599043').send({embeds: [embed]})
            let dm = new MessageEmbed()
            .setDescription(`Поздравляю!\nВы понижены, ваша новая роль: Рядовой (Армия)`)
            .setColor('#2ecc71')
            user.send({ embeds: [dm] })
    ...
    if(azvan === 2) {
        ...
        client.channels.cache.get('1040670230818599043').send({embeds: [embed]})
        let dm = new MessageEmbed()
        .setDescription(`Поздравляю!\nВы понижены, ваша новая роль: Лейтенант (Армия)`)
        .setColor('#2ecc71')
        user.send({ embeds: [dm] })
    ...
    if(azvan === 3) {
        ...
        client.channels.cache.get('1040670230818599043').send({embeds: [embed]})
        let dm = new MessageEmbed()
        .setDescription(`Поздравляю!\nВы понижены, ваша новая роль: Сержант (Армия)`)
        .setColor('#2ecc71')
        user.send({ embeds: [dm] })
...
if(azvan === 4) {
    ...
    client.channels.cache.get('1040670230818599043').send({embeds: [embed]})
    let dm = new MessageEmbed()
    .setDescription(`Поздравляю!\nВы понижены, ваша новая роль: Капитан (Армия)`)
    .setColor('#2ecc71')
    user.send({ embeds: [dm] })
